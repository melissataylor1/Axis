...
const AboutPage = () => {
  return <section className="hero relative">
  ...
  <div className="max-w-6xl mx-auto px-4 sm:px-6 flex h-screen">
    ...
    className="md:mt-8 uppercase relative text-center px-7 py-5 md:px-10 transition-all duration-500
        ...
        after:border after:border-amber/50 after:scale-125 after:hover:opacity-100 after:hover:scale-100" data-aos="zoom-y-out" data-aos-delay="150"
>
    <span className="relative text-white uppercase" id="hero-btn">Get a Free Quote</span>
</button>
      </div>
